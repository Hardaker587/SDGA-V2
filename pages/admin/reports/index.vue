<template>
  <div class="md:w-8/12 mx-auto">
    ...
    <div class="grid grid-cols-2 gap-4 md:grid-cols-3 mb-4">
      <div class="card shadow-lg" @click="$router.push('/admin/reports/bar')">
        <div class="card-body text-center">
          <ChartBarIcon class="h-24 mb-4" />
          <h2 class="card-title">Bar chart</h2>
        </div>
      </div>
      <div class="card shadow-lg" @click="$router.push('/admin/reports/line')">
        <div class="card-body text-center">
          <DocumentReportIcon class="h-24 mb-4" />
          <h2 class="card-title">Line chart</h2>
        </div>
      </div>
      <div class="card shadow-lg" @click="$router.push('/admin/reports/radar')">
        <div class="card-body text-center">
